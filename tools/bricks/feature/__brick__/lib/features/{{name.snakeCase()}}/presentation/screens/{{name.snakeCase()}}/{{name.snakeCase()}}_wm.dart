...
import 'package:surf_flutter_summer_school_24/features/{{name.snakeCase()}}/di/{{name.snakeCase()}}_scope.dart';
import 'package:surf_flutter_summer_school_24/features/{{name.snakeCase()}}/presentation/screens/{{name.snakeCase()}}/{{name.snakeCase()}}_model.dart';
import 'package:surf_flutter_summer_school_24/features/{{name.snakeCase()}}/presentation/screens/{{name.snakeCase()}}/{{name.snakeCase()}}_screen.dart';
