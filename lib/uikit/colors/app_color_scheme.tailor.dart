...
mixin _$AppColorSchemeTailorMixin on ThemeExtension<AppColorScheme> {
  ...
  Color get tetradicBackground;
  Color get onBackground;
  Color get onBackgroundSecondary;
  Color get danger;
  Color get dangerSecondary;
  Color get onDanger;
  Color get textField;
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      const DeepCollectionEquality().hash(backgroundTertiary),
      const DeepCollectionEquality().hash(tetradicBackground),
      ...
      const DeepCollectionEquality().hash(dangerSecondary),
      ...
      const DeepCollectionEquality().hash(skeletonOnPrimary),
